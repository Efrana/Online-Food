...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
	  ...
	  <p><i class="fa fa-certificate fa-spin" style="font-size:25px;color:red">  </i>Baishakhi offer!! Maxican Pasta Special Package.Free Home Delivery.</p>
      ...
      <div class="item">
          <p><i class="fa fa-certificate fa-spin" style="font-size:25px;color:orangered"> </i>Baishakhi Maxican Pasta Special Package.Free Home Delivery.</p>
